...
A dated plan for closing the process and machinery gaps that the first real-ARC ladder exposed. It does not supersede the experimental program — [MVE-PLAN-2026-07-25.md](MVE-PLAN-2026-07-25.md) remains the active execution plan for the experiment set, and this is the prerequisite work that unblocks it. Concepts it leans on: [CERTIFICATE-PROFILE-2026-07-24.md](../../abstraction_ladders/CERTIFICATE-PROFILE-2026-07-24.md) (per-rung verdicts, the double-jump as a (rung, consumer) property), [BREADTH-AXIS-2026-07-24.md](../../abstraction_ladders/BREADTH-AXIS-2026-07-24.md) (the two cost axes), [LADDER-FORMAT.md](../../abstraction_ladders/LADDER-FORMAT.md) (the chosen/derived split), [LADDER-SET-DESIGN-2026-07-24.md](../../abstraction_ladders/LADDER-SET-DESIGN-2026-07-24.md).
...
New: `docs/abstraction_ladders/LADDER-PROCESS.md`. Deliberately short — machinery does the enforcing. Sections:
