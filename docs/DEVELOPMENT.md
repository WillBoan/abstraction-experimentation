...
Superseded dated snapshots live in [archive/](archive/) — including the completed ladder plan lineage (`AL-PLAN-2026-07-23` -> `LADDER-SET-PLAN-2026-07-24` -> `MVE-PLAN-2026-07-25`), the cross-cutting index `TODO-2026-07-22.md`, the dated check inventory `LADDER-CHECKS-2026-07-21.md`, and the ladder idea parking lot `LADDER-IDEAS-2026-08-03.md`. This is the index for them; `CLAUDE.md` deliberately does not list archive paths.
