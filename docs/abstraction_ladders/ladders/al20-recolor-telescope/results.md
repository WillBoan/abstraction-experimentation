...
| ---- | --------------------------------------------------------- | ---------------------- | ------ | --------- |
| 0    | 2: `pair-00`, `pair-01`                                   | 35,335                 | `abs0` | no        |
| 1    | 4: `pair-00`, `pair-01`, `recol-00`, `recol-01`           | 36,585                 | `abs1` | no        |
| 2    | 5: `pair-00`, `pair-01`, `recol-00`, `recol-01`, `top-00` | 37,855                 | -      | yes       |
...
| ---------- | ----- | ------- | ------- | ------- |
| `pair-00`  | pair  | 7,067 * | 7,317 * | 7,571 * |
| `pair-01`  | pair  | 7,067 * | 7,317 * | 7,571 * |
| `recol-00` | recol | 7,067   | 7,317 * | 7,571 * |
| `recol-01` | recol | 7,067   | 7,317 * | 7,571 * |
| `top-00`   | top   | 7,067   | 7,317   | 7,571 * |
...
| ---------- | ------- | ---------------- | -------------------- | ----------------------- | ---------- | ----- |
| `pair-00`  | L_0     | 2                | 148                  | 148                     | 7,067      | 16.01 |
| `pair-00`  | L_1     | 1                | 144                  | 144                     | 7,317      | 16.3  |
| `pair-00`  | L_2     | 1                | 144                  | 144                     | 7,571      | 16.58 |
| `pair-01`  | L_0     | 2                | 148                  | 148                     | 7,067      | 16.01 |
| `pair-01`  | L_1     | 1                | 144                  | 144                     | 7,317      | 16.3  |
| `pair-01`  | L_2     | 1                | 144                  | 144                     | 7,571      | 16.58 |
| `recol-00` | L_1     | 2                | 2,890                | 2,890                   | 7,317      | 16.3  |
| `recol-00` | L_2     | 1                | 145                  | 145                     | 7,571      | 16.58 |
| `recol-01` | L_1     | 2                | 2,890                | 2,890                   | 7,317      | 16.3  |
| `recol-01` | L_2     | 1                | 145                  | 145                     | 7,571      | 16.58 |
| `top-00`   | L_2     | 2                | 7,482                | 7,482                   | 7,571      | 16.58 |
...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| `pair-00`  | L_0     | `__const__` 7,062 (99.9%), `map_color` 6,848 (96.9%), `concat_h` 2,052 (29.0%), `translate` 1,796 (25.4%)                                        |
| `pair-00`  | L_1     | `__const__` 7,304 (99.8%), `map_color` 7,056 (96.4%), `concat_h` 2,142 (29.3%), `translate` 1,830 (25.0%), `pair` 250 (3.4%)                     |
| `pair-00`  | L_2     | `__const__` 7,546 (99.7%), `map_color` 7,264 (95.9%), `concat_h` 2,234 (29.5%), `translate` 1,864 (24.6%), `pair` 254 (3.4%), `recol` 254 (3.4%) |
| `pair-01`  | L_0     | `__const__` 7,062 (99.9%), `map_color` 6,848 (96.9%), `concat_h` 2,052 (29.0%), `translate` 1,796 (25.4%)                                        |
| `pair-01`  | L_1     | `__const__` 7,304 (99.8%), `map_color` 7,056 (96.4%), `concat_h` 2,142 (29.3%), `translate` 1,830 (25.0%), `pair` 250 (3.4%)                     |
| `pair-01`  | L_2     | `__const__` 7,546 (99.7%), `map_color` 7,264 (95.9%), `concat_h` 2,234 (29.5%), `translate` 1,864 (24.6%), `pair` 254 (3.4%), `recol` 254 (3.4%) |
| `recol-00` | L_0     | `__const__` 7,062 (99.9%), `map_color` 6,848 (96.9%), `concat_h` 2,052 (29.0%), `translate` 1,796 (25.4%)                                        |
| `recol-00` | L_1     | `__const__` 7,304 (99.8%), `map_color` 7,056 (96.4%), `concat_h` 2,142 (29.3%), `translate` 1,830 (25.0%), `pair` 250 (3.4%)                     |
| `recol-00` | L_2     | `__const__` 7,546 (99.7%), `map_color` 7,264 (95.9%), `concat_h` 2,234 (29.5%), `translate` 1,864 (24.6%), `pair` 254 (3.4%), `recol` 254 (3.4%) |
| `recol-01` | L_0     | `__const__` 7,062 (99.9%), `map_color` 6,848 (96.9%), `concat_h` 2,052 (29.0%), `translate` 1,796 (25.4%)                                        |
| `recol-01` | L_1     | `__const__` 7,304 (99.8%), `map_color` 7,056 (96.4%), `concat_h` 2,142 (29.3%), `translate` 1,830 (25.0%), `pair` 250 (3.4%)                     |
| `recol-01` | L_2     | `__const__` 7,546 (99.7%), `map_color` 7,264 (95.9%), `concat_h` 2,234 (29.5%), `translate` 1,864 (24.6%), `pair` 254 (3.4%), `recol` 254 (3.4%) |
| `top-00`   | L_0     | `__const__` 7,062 (99.9%), `map_color` 6,848 (96.9%), `concat_h` 2,052 (29.0%), `translate` 1,796 (25.4%)                                        |
| `top-00`   | L_1     | `__const__` 7,304 (99.8%), `map_color` 7,056 (96.4%), `concat_h` 2,142 (29.3%), `translate` 1,830 (25.0%), `pair` 250 (3.4%)                     |
| `top-00`   | L_2     | `__const__` 7,546 (99.7%), `map_color` 7,264 (95.9%), `concat_h` 2,234 (29.5%), `translate` 1,864 (24.6%), `pair` 254 (3.4%), `recol` 254 (3.4%) |
...
- Laddered marginal: 36,339
  - jump `pair`: 14,134
  - jump `recol`: 14,634
  - top jump: 7,571
- Laddered end-to-end: 109,775 (every wake re-searches every task)
- Raw (Floor on the top tasks, reference budget): 7,067 -- a full-budget FAILURE at the reference budget, not a raw cost (the top is unreachable raw by design); the raw ARM below is the RQ1 authority
...
- Laddered marginal, cost-paid-full: 36,339 vs cost-to-first: 13,558
  - jump `pair`: 296
  - jump `recol`: 5,780
  - top jump: 7,482
...
- **Amortization ratio (lower-bound): 10.0x** -- raw arm spend 363,390 against laddered marginal 36,339, guard 10x laddered (363,390 per top task) at depth_limit 5, max_pool 200,000, solution_limit 1.
...
- Raw cost estimate (ADVISORY -- not an RQ1 input): 30,317,358 - 1,458,888,616 considered, extrapolated from observed composed counts [27, 117, 6923] through depth 2 (3 rounds projected to `d_raw`=5). Validated 2026-07-23: the bracket contained the measured truth in 2 of 10 cells, erring both directions -- treat as an order-of-magnitude sketch of unknown sign, never a result.
...
- Marginal (jump costs only, the idealized bound): 36,339
- End-to-end (every wake re-searches every task, incl. full-budget failures): 109,775
...
| ------- | -------------------------------- | ---- | ----------- | ----------------------- | -------- |
| `pair`  | 296                              | 288  | **1.03x**   | 0.97x vs `recol`        | yes      |
| `recol` | 5,780                            | 290  | **19.93x**  | 0.97x vs `top`          | yes      |
...
| ------------ | ------------ | ------------------- | ------ |
| `pair`       | 14,134       | 15,142              | 1.07x  |
| `recol`      | 14,634       | 15,142              | 1.03x  |
...
| ---------------------- | ---------------- | -------------------------------- | -------- | ------------------ | ----- | ------ | ------- |
| chain/L0               | f0d2e8bd60428f70 | 20260803_203138_f0d2e8bd60428f70 | bedb33b8 | al20-L0            | 2     | 400    | exhaust |
| chain/L1               | c7839bcec9405c39 | 20260803_203139_c7839bcec9405c39 | bedb33b8 | al20-L0+pair       | 2     | 400    | exhaust |
| chain/L2               | 37a7eb836dc74ba3 | 20260803_203140_37a7eb836dc74ba3 | bedb33b8 | al20-L0+pair+recol | 2     | 400    | exhaust |
| climb/learn            | 9a84ca44c49201a7 | 20260803_203141_9a84ca44c49201a7 | bedb33b8 | al20-L0            | 2     | 400    | exhaust |
| climb/train-usefulness | 534b120b639031d0 | 20260803_203143_534b120b639031d0 | bedb33b8 | al20-L0+abs0+abs1  | 2     | 400    | exhaust |
| climb/transfer         | a66652c4a051f47d | 20260803_203144_a66652c4a051f47d | bedb33b8 | al20-L0+abs0+abs1  | 2     | 400    | exhaust |
| off-chain              | 021543979b1db8e1 | 20260803_203145_021543979b1db8e1 | bedb33b8 | al20-L0+recol      | 2     | 400    | exhaust |
| raw-arm                | a6d6e2d7f05fd3d9 | 20260803_203146_a6d6e2d7f05fd3d9 | bedb33b8 | al20-L0            | 5     | 200000 | first-1 |
