<!-- Generated by LadderSpec.render() -- regenerate with `arc-lab run-ladder 94f9d214-nor-recolor --artifacts <dir>`; never hand-edit. -->

# LadderSpec: 94f9d214-nor-recolor

Derived from `94f9d214-nor-recolor.ladder` (in `program_search/ladders/registry/`) -- that file is this ladder's source of truth: floor, rung templates, config and tasks. Everything below is COMPUTED from it.
...
- `94f9d214`: d=3, needs depth_limit 3, over `L_4`
