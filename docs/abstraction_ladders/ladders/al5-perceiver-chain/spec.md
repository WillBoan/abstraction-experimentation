...
| ----- | --------------- | ----- | --- | ----- | ------ | ---------- | ----------- | -------- | ------ | ----- | ------------- |
| 1     | `swap_extremes` | 3     | 3   | 3     | 3      | 3          | 5           | 5        | 0      | 2     | full_solution |
| 2     | `swap_mirror`   | 3     | 3   | 3     | 3      | 3          | 5           | 5        | 1      | 2     | full_solution |
| 3     | `swap_stack`    | 3     | 3   | 3     | 3      | 3          | 4           | 4        | 1      | 2     | full_solution |
...
| ----- | --------------- | --------- | -------- | ----- | ------------------------- |
| 1     | `swap_extremes` | 104       | 2        | 52.0x | color: 10 minted / 0 used |
| 2     | `swap_mirror`   | 105       | 4        | 26.2x | color: 10 minted / 1 used |
| 3     | `swap_stack`    | 115       | 9        | 12.8x | color: 10 minted / 2 used |
