...
- Static lint (what this file asserts): **OK** -- 73 checks (errors: 0, warnings: 1)
...
| ----- | --------------- | --- | ----------- | ------ | ----- | ------------- |
| 1     | `swap_extremes` | 3   | 5           | 0      | 2     | full_solution |
| 2     | `swap_mirror`   | 3   | 5           | 1      | 2     | full_solution |
| 3     | `swap_stack`    | 3   | 4           | 1      | 2     | full_solution |
