<!-- Generated by LadderSpec.render() -- regenerate with `arc-lab run-ladder al18-fanin-rotate --artifacts <dir>`; never hand-edit. -->

# LadderSpec: al18-fanin-rotate

Derived from `al18-fanin-rotate.ladder` (in `program_search/ladders/registry/`) -- that file is this ladder's source of truth: floor, rung templates, config and tasks. Everything below is COMPUTED from it.

- Height: 3 (2 bridging rungs + top)
- Floor library: `al18-L0` (4 primitives)
...
| 2     | `rot`        | 2     | 2   | 2     | 2      | 2          | 3           | 3        | 1      | 2     | full_solution |
...
| ----- | ------ | --------- | -------- | ----- | -------------------------- |
| 1     | `pair` | 19        | 2        | 9.5x  | offset: 16 minted / 1 used |
| 2     | `rot`  | 20        | 2        | 10.0x | offset: 16 minted / 0 used |
