<!-- Generated by LadderSpec.render() -- regenerate with `arc-lab run-ladder dae9d2b5-split-recolor-lean --artifacts <dir>`; never hand-edit. -->

# LadderSpec: dae9d2b5-split-recolor-lean

Derived from `dae9d2b5-split-recolor-lean.ladder` (in `program_search/ladders/registry/`) -- that file is this ladder's source of truth: floor, rung templates, config and tasks. Everything below is COMPUTED from it.
