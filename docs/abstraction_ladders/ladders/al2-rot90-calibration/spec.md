<!-- Generated by LadderSpec.render() -- regenerate with `arc-lab run-ladder al2-rot90-calibration --artifacts <dir>`; never hand-edit. -->
...
- Static lint (what this file asserts): **OK** -- 40 checks (errors: 0, warnings: 1)
