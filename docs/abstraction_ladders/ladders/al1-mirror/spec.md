...
- Static lint (what this file asserts): **OK** -- 63 checks (errors: 0, warnings: 2)
  - warn `not-all-telescope`: every rung has fan-in 1 (a pure telescope)
  - warn `primitive-necessity`: floor primitives carried below the level that first needs them, where the carry is not cheap: map_color: needed at L_1 (mirror_recolor), carried from L_0 -- arity 3, superlinear in the pool at any depth
...
| ----- | ---------------- | ----- | --- | ----- | ------ | ---------- | ----------- | -------- | ------ | ----- | ------------- |
| 1     | `rot180`         | 2     | 2   | 2     | 2      | 2          | 3           | 3        | 0      | 2     | full_solution |
| 2     | `mirror_recolor` | 2     | 2   | 2     | 2      | 2          | 3           | 3        | 1      | 2     | full_solution |
...
| ----- | ---------------- | --------- | -------- | ----- | ------------------------- |
| 1     | `rot180`         | 102       | 2        | 51.0x | color: 10 minted / 0 used |
| 2     | `mirror_recolor` | 103       | 5        | 20.6x | color: 10 minted / 2 used |
