...
- Static lint (what this file asserts): **OK** -- 81 checks (errors: 0, warnings: 0)
...
| ----- | ------------ | --- | ----- | ----------- | ------ | ----- | ------------- |
| 1     | `shift1`     | 2   | 2     | 3           | 0      | 2     | full_solution |
| 2     | `frame1`     | 2   | 2     | 3           | 1      | 2     | full_solution |
| 3     | `shift2`     | 2   | 2     | 3           | 2      | 2     | full_solution |
