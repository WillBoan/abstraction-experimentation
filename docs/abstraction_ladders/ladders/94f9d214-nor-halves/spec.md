<!-- Generated by LadderSpec.render() -- regenerate with `arc-lab run-ladder 94f9d214-nor-halves --artifacts <dir>`; never hand-edit. -->

# LadderSpec: 94f9d214-nor-halves

Derived from `94f9d214-nor-halves.ladder` (in `program_search/ladders/registry/`) -- that file is this ladder's source of truth: floor, rung templates, config and tasks. Everything below is COMPUTED from it.
...
- Dependencies (lower-rung calls, with multiplicity):
  ...
  - top `94f9d214`: `north` x1, `south` x1
...
- `94f9d214`: d=4, needs depth_limit 4, over `L_2`
