...
- Static lint (what this file asserts): **OK** -- 81 checks (errors: 0, warnings: 5)
...
| ----- | ------------ | --- | ----- | ----------- | ------ | ----- | ------------- |
| 1     | `swap_ext`   | 3   | 3     | 5           | 0      | 2     | full_solution |
| 2     | `swap_mir`   | 3   | 3     | 5           | 1      | 2     | full_solution |
| 3     | `swap_stk`   | 3   | 3     | 4           | 1      | 2     | full_solution |
