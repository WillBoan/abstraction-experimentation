<!-- Generated by LadderSpec.render() -- regenerate with `arc-lab run-ladder fafffa47-nor-merged --artifacts <dir>`; never hand-edit. -->

# LadderSpec: fafffa47-nor-merged

Derived from `fafffa47-nor-merged.ladder` (in `program_search/ladders/registry/`) -- that file is this ladder's source of truth: floor, rung templates, config and tasks. Everything below is COMPUTED from it.
...
- `fafffa47`: d=2, needs depth_limit 2, over `L_5`
