...
- Depth schedule (`derived`): the `depth_limit` each oracle-chain level runs at, `L_0` first -- [2, 3, 2]. Every sandwich claim below is stated against ITS OWN level's entry.
...
| ----- | ------------ | ----- | --- | ----- | ------ | ---------- | ----------- | -------- | ------ | ----- | ------------- |
| 1     | `sym_h`      | 2     | 2   | 2     | 2      | 2          | 4           | 4        | 0      | 2     | full_solution |
| 2     | `sym_both`   | 3     | 3   | 3     | 3      | 3          | 4           | 4        | 2      | 2     | full_solution |
