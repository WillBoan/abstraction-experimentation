<!-- Generated by LadderSpec.render() -- regenerate with `arc-lab run-ladder fafffa47-recolor-first --artifacts <dir>`; never hand-edit. -->

# LadderSpec: fafffa47-recolor-first

Derived from `fafffa47-recolor-first.ladder` (in `program_search/ladders/registry/`) -- that file is this ladder's source of truth: floor, rung templates, config and tasks. Everything below is COMPUTED from it.
...
- `fafffa47`: d=3, needs depth_limit 3, over `L_2`
