<!-- Generated by LadderSpec.render() -- regenerate with `arc-lab run-ladder al16-layout-nest --artifacts <dir>`; never hand-edit. -->

# LadderSpec: al16-layout-nest

Derived from `al16-layout-nest.ladder` (in `program_search/ladders/registry/`) -- that file is this ladder's source of truth: floor, rung templates, config and tasks. Everything below is COMPUTED from it.

- Height: 3 (2 bridging rungs + top)
- Floor library: `al16-L0` (3 primitives)
...
- Static lint (what this file asserts): **OK** -- 58 checks (errors: 0, warnings: 0)
...
| 2     | `stack`      | 2     | 2   | 2     | 2      | 2          | 3           | 3        | 2      | 2     | full_solution |
...
| ----- | ------- | --------- | -------- | ----- | -------------------------- |
| 1     | `pair`  | 18        | 2        | 9.0x  | offset: 16 minted / 1 used |
| 2     | `stack` | 19        | 2        | 9.5x  | offset: 16 minted / 0 used |
...
al16-layout-nest: OK -- 58 checks (0 errors, 0 warnings)
