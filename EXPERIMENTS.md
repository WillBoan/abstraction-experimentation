...
- **Result:**
  - **The product law is exact, not approximate.** Predicted round-1 count == actual, **24/24 cells**. A rung's cost is computable from its floor's signature before anything is built.
