...
def test_the_census_catches_the_floor_that_cost_five_million() -> None:
    ...
    round-1 width is three orders of magnitude above what the rung needs. THIS is the reading that
    ...
    assert west.b1_full > 1000  # the floor gives it over a thousand
    ratio = west.ratio
